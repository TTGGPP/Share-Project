          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">REGION PRICE PER PYUNG</h3>
              ...
              <!-- /.card-header -->
              <div id="rppp-container" class="card-body table-responsive p-0" style="height: 300px;">
...
$(function() {
	$('#btn-search').on('click', function(event) {
		...
		$('#rppp-container').load('/pgtdashboard-web/rppp-list?rppp=');
