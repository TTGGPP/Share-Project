          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">APT DATA TABLE</h3>
              ...
              <!-- /.card-header -->
              <div id="ydp-container" class="card-body table-responsive p-0" style="height: 300px;">
...
$(function() {
	$('#btn-search').on('click', function(event) {
		...
		$('#ydp-container').load('/pgtdashboard-web/pgt/ydp-list?pricecat='+pricecat);
